...
const SignUpPage = () => {
  ...
  return (
    <div className="md:min-h-screen grid lg:grid-cols-2 bg-white">
      ...
      {/* RIGHT SIDE */}
      <div className="flex items-center justify-center px-6 py-5 md:py-0 lg:px-20">
        <div className="w-full max-w-xl">
          {/* <h2 className="text-3xl font-bold mb-20">Oxyy</h2> */}

          <div className="mb-10">
            <h1 className="text-3xl md:text-6xl font-bold text-black">Registration</h1>
          </div>
          ...
          <Form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <TextField isRequired type="text">
              ...
              <Input
                ...
                {...register("name")}
                className="w-full h-14 border border-gray-300 p-2 rounded-lg"
              />
              <FieldError />
            </TextField>
            {/* Photo URL */}
